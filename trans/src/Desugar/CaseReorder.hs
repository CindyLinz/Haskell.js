...
deCaseReorderActivation :: SrcInfo l => SymbolTableDataCon' l -> Activation l -> Activation l
...
deCaseReorderAlt :: SrcInfo l => SymbolTableDataCon' l -> Alt l -> Alt l
...
deCaseReorderAnnotation :: SrcInfo l => SymbolTableDataCon' l -> Annotation l -> Annotation l
...
deCaseReorderAssoc :: SrcInfo l => SymbolTableDataCon' l -> Assoc l -> Assoc l
...
deCaseReorderAsst :: SrcInfo l => SymbolTableDataCon' l -> Asst l -> Asst l
...
deCaseReorderBangType :: SrcInfo l => SymbolTableDataCon' l -> BangType l -> BangType l
deCaseReorderBangType a1 (BangedTy l) = BangedTy (id l)
deCaseReorderBangType a1 (UnpackedTy l) = UnpackedTy (id l)
deCaseReorderBinds :: SrcInfo l => SymbolTableDataCon' l -> Binds l -> Binds l
...
deCaseReorderBooleanFormula :: SrcInfo l => SymbolTableDataCon' l -> BooleanFormula l -> BooleanFormula l
...
deCaseReorderBracket :: SrcInfo l => SymbolTableDataCon' l -> Bracket l -> Bracket l
...
deCaseReorderCName :: SrcInfo l => SymbolTableDataCon' l -> CName l -> CName l
...
deCaseReorderCallConv :: SrcInfo l => SymbolTableDataCon' l -> CallConv l -> CallConv l
...
deCaseReorderClassDecl :: SrcInfo l => SymbolTableDataCon' l -> ClassDecl l -> ClassDecl l
...
deCaseReorderConDecl :: SrcInfo l => SymbolTableDataCon' l -> ConDecl l -> ConDecl l
...
deCaseReorderContext :: SrcInfo l => SymbolTableDataCon' l -> Context l -> Context l
...
deCaseReorderDataOrNew :: SrcInfo l => SymbolTableDataCon' l -> DataOrNew l -> DataOrNew l
deCaseReorderDataOrNew a1 (DataType l) = DataType (id l)
deCaseReorderDataOrNew a1 (NewType l) = NewType (id l)
deCaseReorderDecl :: SrcInfo l => SymbolTableDataCon' l -> Decl l -> Decl l
...
deCaseReorderDeclHead :: SrcInfo l => SymbolTableDataCon' l -> DeclHead l -> DeclHead l
...
deCaseReorderDeriving :: SrcInfo l => SymbolTableDataCon' l -> Deriving l -> Deriving l
deCaseReorderDeriving a1 (Deriving l instRule) = Deriving (id l) (fmap (deCaseReorderInstRule a1) instRule)
deCaseReorderExp :: SrcInfo l => SymbolTableDataCon' l -> Exp l -> Exp l
...
deCaseReorderExportSpec :: SrcInfo l => SymbolTableDataCon' l -> ExportSpec l -> ExportSpec l
...
deCaseReorderExportSpecList :: SrcInfo l => SymbolTableDataCon' l -> ExportSpecList l -> ExportSpecList l
...
deCaseReorderFieldDecl :: SrcInfo l => SymbolTableDataCon' l -> FieldDecl l -> FieldDecl l
...
deCaseReorderFieldUpdate :: SrcInfo l => SymbolTableDataCon' l -> FieldUpdate l -> FieldUpdate l
...
deCaseReorderFunDep :: SrcInfo l => SymbolTableDataCon' l -> FunDep l -> FunDep l
deCaseReorderFunDep a1 (FunDep l name1 name2) = FunDep (id l) (fmap (deCaseReorderName a1) name1) (fmap (deCaseReorderName a1) name2)
deCaseReorderGadtDecl :: SrcInfo l => SymbolTableDataCon' l -> GadtDecl l -> GadtDecl l
...
deCaseReorderImportSpec :: SrcInfo l => SymbolTableDataCon' l -> ImportSpec l -> ImportSpec l
...
deCaseReorderImportSpecList :: SrcInfo l => SymbolTableDataCon' l -> ImportSpecList l -> ImportSpecList l
...
deCaseReorderInstDecl :: SrcInfo l => SymbolTableDataCon' l -> InstDecl l -> InstDecl l
...
deCaseReorderInstHead :: SrcInfo l => SymbolTableDataCon' l -> InstHead l -> InstHead l
...
deCaseReorderInstRule :: SrcInfo l => SymbolTableDataCon' l -> InstRule l -> InstRule l
...
deCaseReorderKind :: SrcInfo l => SymbolTableDataCon' l -> Kind l -> Kind l
...
deCaseReorderLiteral :: SrcInfo l => SymbolTableDataCon' l -> Literal l -> Literal l
...
deCaseReorderMatch :: SrcInfo l => SymbolTableDataCon' l -> Match l -> Match l
...
deCaseReorderModule :: SrcInfo l => SymbolTableDataCon' l -> Module l -> Module l
...
deCaseReorderModuleHead :: SrcInfo l => SymbolTableDataCon' l -> ModuleHead l -> ModuleHead l
...
deCaseReorderModuleName :: SrcInfo l => SymbolTableDataCon' l -> ModuleName l -> ModuleName l
deCaseReorderModuleName a1 (ModuleName l string) = ModuleName (id l) (id string)
deCaseReorderModulePragma :: SrcInfo l => SymbolTableDataCon' l -> ModulePragma l -> ModulePragma l
...
deCaseReorderName :: SrcInfo l => SymbolTableDataCon' l -> Name l -> Name l
deCaseReorderName a1 (Ident l string) = Ident (id l) (id string)
deCaseReorderName a1 (Symbol l string) = Symbol (id l) (id string)
deCaseReorderNamespace :: SrcInfo l => SymbolTableDataCon' l -> Namespace l -> Namespace l
...
deCaseReorderOp :: SrcInfo l => SymbolTableDataCon' l -> Op l -> Op l
...
deCaseReorderOverlap :: SrcInfo l => SymbolTableDataCon' l -> Overlap l -> Overlap l
...
deCaseReorderPXAttr :: SrcInfo l => SymbolTableDataCon' l -> PXAttr l -> PXAttr l
deCaseReorderPXAttr a1 (PXAttr l xName pat) = PXAttr (id l) (deCaseReorderXName a1 xName) (deCaseReorderPat a1 pat)
deCaseReorderPat :: SrcInfo l => SymbolTableDataCon' l -> Pat l -> Pat l
...
deCaseReorderPatField :: SrcInfo l => SymbolTableDataCon' l -> PatField l -> PatField l
...
deCaseReorderPatternSynDirection :: SrcInfo l => SymbolTableDataCon' l -> PatternSynDirection l -> PatternSynDirection l
...
deCaseReorderPromoted :: SrcInfo l => SymbolTableDataCon' l -> Promoted l -> Promoted l
...
deCaseReorderQName :: SrcInfo l => SymbolTableDataCon' l -> QName l -> QName l
...
deCaseReorderQOp :: SrcInfo l => SymbolTableDataCon' l -> QOp l -> QOp l
...
deCaseReorderQualConDecl :: SrcInfo l => SymbolTableDataCon' l -> QualConDecl l -> QualConDecl l
...
deCaseReorderQualStmt :: SrcInfo l => SymbolTableDataCon' l -> QualStmt l -> QualStmt l
...
deCaseReorderRPat :: SrcInfo l => SymbolTableDataCon' l -> RPat l -> RPat l
...
deCaseReorderRPatOp :: SrcInfo l => SymbolTableDataCon' l -> RPatOp l -> RPatOp l
...
deCaseReorderRhs :: SrcInfo l => SymbolTableDataCon' l -> Rhs l -> Rhs l
...
deCaseReorderRole :: SrcInfo l => SymbolTableDataCon' l -> Role l -> Role l
...
deCaseReorderRule :: SrcInfo l => SymbolTableDataCon' l -> Rule l -> Rule l
...
deCaseReorderRuleVar :: SrcInfo l => SymbolTableDataCon' l -> RuleVar l -> RuleVar l
...
deCaseReorderSafety :: SrcInfo l => SymbolTableDataCon' l -> Safety l -> Safety l
...
deCaseReorderSign :: SrcInfo l => SymbolTableDataCon' l -> Sign l -> Sign l
deCaseReorderSign a1 (Signless l) = Signless (id l)
deCaseReorderSign a1 (Negative l) = Negative (id l)
deCaseReorderSpecialCon :: SrcInfo l => SymbolTableDataCon' l -> SpecialCon l -> SpecialCon l
...
deCaseReorderSplice :: SrcInfo l => SymbolTableDataCon' l -> Splice l -> Splice l
...
deCaseReorderStmt :: SrcInfo l => SymbolTableDataCon' l -> Stmt l -> Stmt l
...
deCaseReorderTyVarBind :: SrcInfo l => SymbolTableDataCon' l -> TyVarBind l -> TyVarBind l
...
deCaseReorderType :: SrcInfo l => SymbolTableDataCon' l -> Type l -> Type l
...
deCaseReorderTypeEqn :: SrcInfo l => SymbolTableDataCon' l -> TypeEqn l -> TypeEqn l
deCaseReorderTypeEqn a1 (TypeEqn l type1 type2) = TypeEqn (id l) (deCaseReorderType a1 type1) (deCaseReorderType a1 type2)
deCaseReorderWarningText :: SrcInfo l => SymbolTableDataCon' l -> WarningText l -> WarningText l
...
deCaseReorderXAttr :: SrcInfo l => SymbolTableDataCon' l -> XAttr l -> XAttr l
deCaseReorderXAttr a1 (XAttr l xName exp) = XAttr (id l) (deCaseReorderXName a1 xName) (deCaseReorderExp a1 exp)
deCaseReorderXName :: SrcInfo l => SymbolTableDataCon' l -> XName l -> XName l
